...
<head>
    ...
    <style>
        * {
        ...
        body {
    background: linear-gradient(15deg, #a6a0cc, #ffffff); /* Slightly angled gradient */
    color: var(--dark);
    line-height: 1.6;
    overflow-x: hidden;
}
        ...
        <section id="about">
            ...
            <div class="about-content">
                <div class="about-text">
                    <p>I am a dedicated electrical engineering student at the University of Pretoria, passionate about developing innovative solutions in power electronics, control systems, and programming with C++, Python, and MATLAB. I thrive in dynamic, hands-on environments that challenge my technical expertise and problem-solving skills.</p>
        
                    <p>My leadership and mentorship abilities are evident from my experience tutoring university-level physics. I independently managed classes, created course materials, and helped students grasp complex concepts. This role enhanced my communication skills and reinforced my ability to inspire and support others.</p>
        
                    <p>Beyond academics, I excel in project execution and teamwork. My involvement in significant projects like robot design and autonomous system development has equipped me with creative problem-solving skills and practical insights into advanced engineering applications, including energy management systems and hybrid storage solutions.</p>
        
                    <p>With a strong academic background, practical technical experience, and a collaborative spirit, I am eager to contribute to engineering roles that blend innovation with real-world application. My goal is to drive meaningful advancements that address real-world challenges while continuously learning and growing as a professional.</p>
                </div>
            </div>
        </section>
-->
...
<!--No CSS file for this contraption -->
